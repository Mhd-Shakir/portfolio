      ...
      <div className="flex justify-between items-center mb-6">
        ...
        {contacts.length > 0 && (
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-red-100 hover:bg-red-200 text-red-700 rounded transition-colors"
          >
            <Trash2 size={16} />
            Delete All
          </button>
              ...
              <tr key={contact._id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 border-b dark:border-gray-700">
                ...
                <td className="p-4">
                  <div className="flex flex-col gap-1">
                    <a href={`mailto:${contact.email}`} className="flex items-center gap-2 text-blue-600 hover:underline text-sm">
                      <Mail size={14} />
                      {contact.email}
                    </a>
                    <a href={`tel:${contact.phone}`} className="flex items-center gap-2 text-green-600 hover:underline text-sm">
                      <Phone size={14} />
                      {contact.phone}
                    </a>
                  </div>
                ...
                <td className="p-4 text-sm max-w-xs" title={contact.message}>
